...
type UserServiceClient interface {
	ChangeUserPrivilege(ctx context.Context, in *InternalChangePrivilegeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *userServiceClient) ChangeUserPrivilege(ctx context.Context, in *InternalChangePrivilegeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *userServiceClient) VerifyPassword(ctx context.Context, in *VerifyPasswordRequest, opts ...grpc.CallOption) (*VerifyPasswordResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protos.UserService/VerifyPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *InternalNewUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *InternalDeleteUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *userServiceClient) SearchForUsers(ctx context.Context, in *InternalSearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
...
type UserServiceServer interface {
	ChangeUserPrivilege(context.Context, *InternalChangePrivilegeRequest) (*emptypb.Empty, error)
...
func (UnimplementedUserServiceServer) ChangeUserPrivilege(context.Context, *InternalChangePrivilegeRequest) (*emptypb.Empty, error) {
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *InternalNewUserRequest) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *InternalDeleteUserRequest) (*emptypb.Empty, error) {
...
func _UserService_ChangeUserPrivilege_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InternalChangePrivilegeRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ChangeUserPrivilege(ctx, req.(*InternalChangePrivilegeRequest))
	}
...
func _UserService_VerifyPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.UserService/VerifyPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CreateUser(ctx, req.(*InternalNewUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserService_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InternalDeleteUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).DeleteUser(ctx, req.(*InternalDeleteUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_SearchForUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SearchForUsers(ctx, req.(*InternalSearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_ChangePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ChangePassword(ctx, req.(*InternalChangePasswordRequest))
	}
	return interceptor(ctx, in, info, handler)
}
